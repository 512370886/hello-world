...
看到新的页面->再点击->再等待。而采用了AJAX技术之后，大部分的计算工作，都是在用户不察觉的情况下，交由服务器去完成了
创建ajax的步骤
...
global	Boolean	默认为true。表示是否触发全局Ajax事件，设置为false将不会触发。AjaxStart或AjaxStop可用于控制各种Ajax事件原文地址：http://blog.poetries.top/2016/11/26/Ajax-summary/