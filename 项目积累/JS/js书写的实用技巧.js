...
代码可读性降低
调试之alert
我没有实习之前不喜欢用alert的，现在也不怎么用，都是console.log，
这样就可以在浏览器的控制台中看到页面数据的输出，但是h5不一样，h5有时候pc端没什么问题，
但是手机端就是各种bug，想调试一个数据很麻烦，但是我们有个宝贝，
alert这个东西在手机端调试比console.log棒的地方就是我们能看见我们的数据，他会以一个弹框的形式显示给我们
...
绑定this
这个怎么解释呢？其实es6箭头函数已经解决了，我也当一个技巧跟大家絮叨絮叨，
我们在设计整个js代码怎么书写的时候，常常会把一块功能相同的代码放到一块，看看下面的例子，你就懂了
function bindEvent(){
    let _this = this;
    function a () {
        //可以在a中使用_this;
...
总结：
上面很多技巧，我平时也在用，如果有错，请你们纠正，如果有受益，麻烦点个赞，谢谢。
https://github.com/laihuamin/JS-total/issues/10
真知源于实践，此篇文档纯原创，要转载请注明出处，喜欢的点个star